    ...
    render() {
        return (
            <div className="apps-container">
                <AppDiv path="/Medly" logoPath={require("../../res/MedlyS.png")} appName={"Medly"} textColor={'medly-text-color'}
